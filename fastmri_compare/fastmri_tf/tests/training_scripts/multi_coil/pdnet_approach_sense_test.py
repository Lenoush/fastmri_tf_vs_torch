...
from fastmri_tf.training_scripts.multi_coil import pdnet_approach_sense
from fastmri_tf.training_scripts.multi_coil.pdnet_approach_sense import train_pdnet
