import sys
sys.path.append("/volatile/Lena/Codes/Modèles/fastmri-reproducible-benchmark/")
...
def train_xpdnet(
    ...
    n_volumes = len([name for name in os.listdir(train_path)])
    af = int(af)
    ...
    ##Lena 
    result = model.predict(train_set, steps=n_steps)
    ##
